...
class MyCMSRss extends Decorator
{
    /**
     * @var array
     */
     ...
     * @var string
     */
    protected $frontendTemplate = 'dashboard::widgets.mycms_rss.template';
    ...
    {
        $request = CacheFacade::remember('mycms.rss', 20, function () {
            return file_get_contents('http://www.gamespot.com/feeds/new_releases');
        });
