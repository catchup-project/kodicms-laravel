...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.ru = {
		...
		messages   : {
			...
			'errURL'               : 'Некорректная настройка. Необходимо указать URL Serverа.',
			'errAccess'            : 'Dashboard (backend) запрещен.',
			'errConnect'           : 'Не удалось соединиться с Serverом.',
			'errAbort'             : 'Соединение прервано.',
			'errTimeout'           : 'Таймаут соединения.',
			'errNotFound'          : 'Server не найден.',
			'errResponse'          : 'Некорректный ответ Serverа.',
			'errConf'              : 'Некорректная настройка Serverа.',
			...
			'errCmdReq'            : 'Для запроса к Serverу необходимо указать имя комманды.',
			...
			'errPerm'              : 'Dashboard (backend) запрещен.',
			...
			'errFileNotFound'      : 'file не найден.',
			'errTrgFolderNotFound' : 'Целевая папка "$1" не найдена.',
			'errPopup'             : 'Браузер заблокировал открытие нового окна. Чтобы окрыть файл, измените Settings браузера.',
			...
			'errFileMaxSize'       : 'size файла превышает допустимый.',
			...
			'errNoArchive'         : 'file не является архивом допустимого типа.',
			'errCmdNoSupport'      : 'Server не поддерживает эту комманду.',
			...
			'errArcMaxSize'        : 'size файлов в архиве превышает максимально разрешенный.',
			'errResize'            : 'Не удалось изменить размер "$1".',
			'errUsupportType'      : 'Неподдерживаемый тип файла.',
			'errNotUTF8Content'    : 'file "$1" содержит текст в кодировке отличной от UTF-8 и не может быть отредактирован.',  // added 9.11.2011
			'errNetMount'          : 'Не удалось подKeyить "$1".',    // added 17.04.2012
			...
			'btnNo'     : 'Нет',
			'btnYes'    : 'Да',
			'btnMount'  : 'ПодKeyить',  // added 18.04.2012
			/******************************** notifications ********************************/
			'ntfopen'     : 'Открытие папки',
			'ntffile'     : 'Открытие файла',
			'ntfreload'   : 'Update текущей папки',
			...
			'help'            : 'Помощь',
			'webfm'           : 'Filemanager Index для web',
			'ver'             : 'Версия',
			...
			'shortcutsof'     : 'Горячие клавиши отKeyены',
			...
			'rmFromPlaces'    : 'remove из избранного',
			...
			'degree'          : '°',
			'netMountDialogTitle' : 'ПодKeyить сетевой диск', // added 18.04.2012
