...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.bg = {
		...
		messages   : {
			...
			'errJqui'              : 'Грешна конфигурация на jQuery UI. Компонентите selectable, draggable и droppable трябва да са вKeyени.',
			'errNode'              : 'elFinder изисква да бъде създаден DOM елемент.',
			'errURL'               : 'Грешка в Settingsте на elFinder! не е зададена стойност на URL.',
			...
			'errConf'              : 'Грешни Settings на сървъра.',
			...
			'errLocked'            : '"$1" е заKeyен и не може да бъде преименуван, местен или премахван.',
			...
			'errPopup'             : 'Браузъра блокира отварянето на прозорец. За да отворите файла, разрешете отварянето в Settingsте на браузъра.',
			...
			'shortcutsof'     : 'Преките пътища са изKeyени',
